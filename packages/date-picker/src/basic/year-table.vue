...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'element-ui-david/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'element-ui-david/src/utils/util';
