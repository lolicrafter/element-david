...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-david/src/utils/date-util';
  import ElScrollbar from 'element-ui-david/packages/scrollbar';
  import RepeatClick from 'element-ui-david/src/directives/repeat-click';
