...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'element-ui-david/src/utils/date-util';
  import { hasClass } from 'element-ui-david/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'element-ui-david/src/utils/util';
