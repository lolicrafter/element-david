<script>
  ...
  import ElButton from 'element-ui-david/packages/button';
  import ElButtonGroup from 'element-ui-david/packages/button-group';
  import { generateId } from 'element-ui-david/src/utils/util';
